...
@property (nonatomic, strong) NSString *firmwareHexStr;
@property (nonatomic, assign) uint32_t u_Vid;         //Luoke FFFF
@property (nonatomic, assign) uint32_t u_Pid;
@property (nonatomic, assign) uint32_t u_Mac;
@property (nonatomic, assign) uint16_t u_manufacureID_Mac;
...
@property (nonatomic, assign) uint32_t u_meshUuid;    //Luoke 1102
